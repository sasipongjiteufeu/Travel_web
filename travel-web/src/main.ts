...
const FOOD_ITEMS: ReadonlyArray<FoodItem> = [
  ...
  },
  {
    code: "D2",
    pagerCode: "D",
    title: "ผัดไทยท่าฉางแม่เพ็ญ",
    intro:
      "ผัดไทยท่าฉางแม่เพ็ญ เส้นนุ่มชุ่มซอสสูตรโบราณ รสเข้มข้นจัดจ้าน อร่อยครบรส จบในจานเดียว",
    tagline: "ผัดไทยท่าฉางแม่เพ็ญ เส้นนุ่มชุ่มซอสสูตรโบราณ รสเข้มข้นจัดจ้าน อร่อยครบรส จบในจานเดียว",
    highlights: [
      "ปรุงใหม่ จานต่อจาน สด สะอาด",
      "รสชาติถึงเครื่อง เน้นเรื่องความสะอาด",
      "อร่อยหลักร้อย จ่ายน้อยแค่ 30 บาท",
      "ผัดไทยรสมือแม่... เสน่ห์ชาวท่าฉาง",
    ],
    story: [
      'จากเมนูเส้นยอดนิยมระดับประเทศ สู่การรังสรรค์รสชาติอันเป็นเอกลักษณ์ฉบับท้องถิ่น "ผัดไทย     ท่าฉางแม่เพ็ญ"เกิดจากการต่อยอดภูมิปัญญาที่นำความกลมกล่อมมาปรับให้เข้ากับรสนิยมของชาวท่าฉางอย่างลงตัว หัวใจสำคัญของความอร่อยอยู่ที่ความใส่ใจในทุกรายละเอียด เริ่มตั้งแต่การคัดสรรวัตถุดิบสดใหม่ภายในชุมชน ไปจนถึงน้ำซอสและเส้นที่ได้มาตรฐาน โดยยึดมั่นในเรื่องความสะอาดและความสดใหม่เป็นที่ตั้ง เพื่อให้ทุกจานเป็นมื้ออาหารที่ปลอดภัยและเปี่ยมด้วยคุณภาพ',
      'เสน่ห์ที่ขาดไม่ได้คือการปรุงสดใหม่แบบ "จานต่อจาน" ส่งกลิ่นหอมกรุ่นจากกระทะพร้อมเสิร์ฟ       ให้รับประทานทันที เพื่อให้ได้รสสัมผัสที่ดีที่สุด ทั้งหมดนี้มาพร้อมกับความคุ้มค่าในราคาที่ทุกคนเข้าถึงได้  เพียงประมาณ 30 บาท ผัดไทท่าฉางแม่เพ็ญจึงไม่ใช่เพียงแค่อาหารจานด่วนที่เรียบง่าย แต่เป็นจานอร่อยที่สะท้อนความตั้งใจจริงของคนในชุมชน ที่มุ่งมั่นมอบความสุขและความประทับใจผ่านรสชาติที่จริงใจและคุ้มค่าเกินราคา',
    ],
    contacts: [
      "บ้านเลขที่ 4 หมู่ที่ 5 ตำบลเขาถ่าน อำเภอท่าฉาง จังหวัดสุราษฎร์ธานี",
      "ชื่อร้าน ร้านเครื่องแกงแม่เพ็ญบ้านหนองดูน",
  ...
  },
  {
    ...
    mapEmbed: "https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3937.3876202356178!2d99.15678372586228!3d9.298879966911374!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOcKwMTcnNTYuMCJOIDk5wrAwOSc0Mi4wIkU!5e0!3m2!1sth!2sth!4v1770914865797!5m2!1sth!2sth",
    mapLink: "https://maps.app.goo.gl/qj4mLcJbEKTg924u6",
    images: ["1_0.jpg", "2_0.jpg", "3_0.jpg", "4_0.jpg", "5_0.jpg", "6_0.jpg"],
  },
  {
    code: "E",
